                ...
                <div class="list-item" data-parent>
                    <div class="list-item__inner">
                        <div class="list-item__arrow-container">
                            ${data.hasChildren ? '<img class="list-item__arrow" src="src/img/chevron-down.png" alt="chevron-down" data-open>' : ''}
                        </div>
                        <img class="list-item__folder" src="src/img/folder.png" alt="folder">
